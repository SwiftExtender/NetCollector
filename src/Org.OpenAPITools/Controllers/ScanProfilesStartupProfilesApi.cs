...
{ 
    ...
    { 
        ...
        public virtual IActionResult ScanProfilesStartupProfilesDelete([FromQuery (Name = "scan_profile_id")]string scanProfileId, [FromQuery (Name = "startup_profile_id")]string startupProfileId, [FromQuery (Name = "order")]string order, [FromHeader (Name = "Prefer")]string prefer)
        {
